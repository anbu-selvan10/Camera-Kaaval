  ...
  return (
    ...
    >
      <View style={styles.slideContainer}>
        <Image source={require("../assets/images/sliderimg1.jpeg")} style={styles.imageSlide} />
      ...
      <View style={styles.slideContainer}>
        <Image source={require("../assets/images/sliderimg2.jpeg")} style={styles.imageSlide} />
        <View style={styles.textContainer}>
      ...
      <View style={styles.slideContainer}>
        <Image source={require("../assets/images/sliderimg3.jpeg")} style={styles.imageSlide} />
        <View style={styles.textContainer}>
